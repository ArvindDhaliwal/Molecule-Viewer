...
def molappend_atom(molecule1, atom1):
    return _molecule.molappend_atom(molecule1, atom1)

def molappend_bond(molecule1, bond1):
    return _molecule.molappend_bond(molecule1, bond1)
